...
class CounterMolecule extends Molecule {
  ...
  @override
  List<Atom> get atoms => [counterAtom, incrementAtom];
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  Widget build(BuildContext context) {
    return StateMoleculeBond(
        molecule: counterMolecule,
        builder: (context) {
          return Scaffold(
            appBar: AppBar(
            ...
            body: Center(
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    '${counterMolecule.counterAtom.value}',
                  ...
                  Text(
                    '${counterMolecule.inverseCounterAtom.value}',
                    style: Theme.of(context).textTheme.headlineMedium,
                  ),
                ],
              ),
